defmodule CommentBoxElixir.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule CommentBoxElixir.MyChannel do
        use CommentBoxElixir.Web, :channel
        alias CommentBoxElixir.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :comment_box_elixir,
                        pubsub_server: CommentBoxElixir.PubSub
end
